 ...
 */
@Configuration
public class ServicioSeguridadPaqueteríaApp {
    @Autowired
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        //        .withUser("paqueteriaapp").roles("CLIENTE").password("{noop}secret");
    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests().antMatchers(HttpMethod.POST, "/paqueteriaapp/clientes").anonymous();
        // Permitir el acceso de un cliente sólo a sus recursos asociados (datos personales, cuentas, tarjetas, etc.)
        httpSecurity.authorizeRequests().antMatchers("/paqueteriaapp/clientes/{dni}/**")
